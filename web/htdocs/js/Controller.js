...
class Controller {
    ...
    static PYSWITCH_VERSION = "2.4.10";                          // Version of PySwitch this emulator is designed to run with
    static VERSION = Controller.PYSWITCH_VERSION + ".17";        // PySwitch Emulator Version
