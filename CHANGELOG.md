...
- Bug fixes:
    - Fixed `EFFECT_STATE_PER_RIG` rig_overrides with string keys (as generated by the web editor) not matching the integer rig ID from the Kemper MIDI mapping, leaving switches disabled.
