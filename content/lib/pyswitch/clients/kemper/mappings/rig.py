...
def MAPPING_RIG_VOLUME(): 
    return ClientParameterMapping.get(
        name = "RigVol",
        set = (0xf0, 0x00, 0x20, 0x33, PRODUCT_TYPE, DEVICE_ID_OMNI, 0x01, INSTANCE_ID, 0x04, 0x01, 0x00, 0x00, 0xf7),
        request = (0xf0, 0x00, 0x20, 0x33, PRODUCT_TYPE, DEVICE_ID_OMNI, 0x41, INSTANCE_ID, 0x04, 0x01, 0xf7),
        response = (0xf0, 0x00, 0x20, 0x33, PRODUCT_TYPE, DEVICE_ID_OMNI, 0x01, INSTANCE_ID, 0x04, 0x01, 0x00, 0x00, 0xf7)
    )
...
def MAPPING_RIG_TRANSPOSE(): 
    return ClientParameterMapping.get(
        name = "RigTrans",
        set = (0xf0, 0x00, 0x20, 0x33, PRODUCT_TYPE, DEVICE_ID_OMNI, 0x01, INSTANCE_ID, 0x04, 0x04, 0x00, 0x00, 0xf7),
        request = (0xf0, 0x00, 0x20, 0x33, PRODUCT_TYPE, DEVICE_ID_OMNI, 0x41, INSTANCE_ID, 0x04, 0x04, 0xf7),
        response = (0xf0, 0x00, 0x20, 0x33, PRODUCT_TYPE, DEVICE_ID_OMNI, 0x01, INSTANCE_ID, 0x04, 0x04, 0x00, 0x00, 0xf7)
    )
