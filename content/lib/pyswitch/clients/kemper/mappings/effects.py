...
def MAPPING_DLY_REV_MIX(slot_id):
    return ClientParameterMapping.get(
        ...
        set = (0xf0, 0x00, 0x20, 0x33, PRODUCT_TYPE, DEVICE_ID_OMNI, 0x01, INSTANCE_ID, KemperEffectSlot.NRPN_SLOT_ADDRESS_PAGE[slot_id], 0x45, 0xf7),
        # KemperNRPNMessage(
        #     0x01, 
        ...
        #     0x45
        # ),
        response = (0xf0, 0x00, 0x20, 0x33, PRODUCT_TYPE, DEVICE_ID_OMNI, 0x01, INSTANCE_ID, KemperEffectSlot.NRPN_SLOT_ADDRESS_PAGE[slot_id], 0x45, 0xf7)
        # KemperNRPNMessage(               
        #     0x01, 
        #     KemperEffectSlot.NRPN_SLOT_ADDRESS_PAGE[slot_id],
        #     0x45
