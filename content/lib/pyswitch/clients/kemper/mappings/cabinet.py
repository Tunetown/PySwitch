...
def MAPPING_CABINET_STATE(): 
    return ClientParameterMapping.get(
        name = "Cab State",
        set = (0xf0, 0x00, 0x20, 0x33, PRODUCT_TYPE, DEVICE_ID_OMNI, 0x01, INSTANCE_ID, 0x0c, 0x02, 0xf7),
        # KemperNRPNMessage(
        #     0x01, 
        #     0x0c,
        #     0x02
        ...
        #     0x02
        # ),
        response = (0xf0, 0x00, 0x20, 0x33, PRODUCT_TYPE, DEVICE_ID_OMNI, 0x01, INSTANCE_ID, 0x0c, 0x02, 0xf7)
        # KemperNRPNMessage(
        #     0x01,
        #     0x0c,
        #     0x02
